...
[![License](https://img.shields.io/github/license/yourusername/url-safety-checker)](LICENSE)
...
- ✅ **Real-time URL scanning** using Google Safe Browsing
- ⚠️ **Visual warnings** for unsafe pages
